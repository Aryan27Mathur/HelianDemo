<template>
 <v-container class="bg-teal-darken-4" fluid>
    <v-row class="ma-12"> 
        <v-col class="mx-2">
        ...
        <v-col class="mx-2">
            <v-card class="bg-teal-lighten-1" variant="elevated" height='100%'>
                <v-card-title>Track The Impact of Your Portfolio</v-card-title>
                <v-card-text >Monitor the environmental and social impact of your investments alongside financial performance, from carbon emissions to gender equality initiatives.</v-card-text >
            </v-card>
        </v-col>
        <v-col class="mx-2">
            <v-card class="bg-teal-lighten-1" variant="elevated" height='100%'>
